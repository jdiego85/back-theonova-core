...
import com.theonova.gateways.inventory.InventoryMovementRepositoryPort;
import org.springframework.stereotype.Service;

import java.util.List;

@Service
public class InventoryMovementRepositoryService implements InventoryMovementRepositoryPort {
    @Override
    ...
    @Override
    public InventoryMovement saveItem(InventoryMovement request) {
        return null;
    }
