...
public class OrderStatusHistoryServiceAdapter implements OrderStatusHistoryGateway {
    ...
    public OrderStatusHistory saveItem(OrderStatusHistory item) {
        ...
        return entityToDomain(orderStatusHistoryRepository.save(entity));
    }
    ...
    public Optional<OrderStatusHistory> findById(Long id) {
        return orderStatusHistoryRepository.findById(id).map(this::entityToDomain);
    }
    ...
    private OrderStatusHistory entityToDomain(OrderStatusHistoryEntity entity) {
