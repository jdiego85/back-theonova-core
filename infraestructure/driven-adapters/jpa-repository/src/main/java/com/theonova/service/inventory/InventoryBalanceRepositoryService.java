...
import com.theonova.gateways.inventory.InventoryBalanceRepositoryPort;
...
@Service
public class InventoryBalanceRepositoryService implements InventoryBalanceRepositoryPort {
    @Override
    ...
    @Override
    public InventoryBalance saveItem(InventoryBalance request) {
        return null;
    }
